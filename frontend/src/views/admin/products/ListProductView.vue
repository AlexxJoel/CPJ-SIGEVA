...
const goToPage = (page: number) => {
  ...
  window.scrollTo({top: 0, behavior: "smooth"});
    ...
    const reloadProduct = () => getProducts();
    ...
    <template>
      <div>
        ...
        <SkeletonCards :loading="isLoading" :quantity-cards="8" :col-lg="4"/>
        ...
        <ModalSaveProduct @reloadProducts="reloadProduct"/>
        <ModalUpdateProduct v-if="selectedProduct" @reloadProducts="reloadProduct" :item-selected="selectedProduct"/>
  </div>
</template>
